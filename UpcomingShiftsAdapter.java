...
public class UpcomingShiftsAdapter extends RecyclerView.Adapter<UpcomingShiftsAdapter.MyViewHolder>{
    ...
    @NonNull
    @Override
    public UpcomingShiftsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       // inflate layout and give a look to each row
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.upcomingshiftrows, parent,false);
        return new UpcomingShiftsAdapter.MyViewHolder(view);
    }

    //called to display the data at the specified position
    @Override
    public void onBindViewHolder(@NonNull UpcomingShiftsAdapter.MyViewHolder holder, int position) {
