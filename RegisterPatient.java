...
public class RegisterPatient extends AppCompatActivity {
    ...
    // need instance of firebase, tbh i don't really get why, just that you need to do it
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //once again have no idea what this line does
        ...
        RegisterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Patient newPatient = new Patient(firstName,lastName,email, password,phone,patientAddress,healthCardNumber);
