...
import static com.uottawa.eecs.SEGDeliverable4.doctor.appointment.UpcomingDoctorApptTab.username;
...
public class UpcomingApptItemAdapter extends FirebaseRecyclerAdapter<Appointment, UpcomingApptItemAdapter.myViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull UpcomingApptItemAdapter.myViewHolder holder, int position, @NonNull Appointment model) {
        ...
        String drEmail = model.sanitizeEmail(username);
        ...
        holder.accept.setOnClickListener(view -> {
            //accepted
               ...
               // NEED TO MAKE SURE ON CREATION THAT THEY HAVE THE **SAME** ID SO THAT WE CAN DO THIS
               userRef = databaseReference.child("PatientAppointments").child(sanitize).child("Upcoming").child(userID);
               userRef.setValue(model);
